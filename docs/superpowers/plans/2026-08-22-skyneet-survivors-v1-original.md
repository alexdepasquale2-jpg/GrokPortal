> **FROZEN — DO NOT EDIT.** This is the original v1 implementation plan as authored on
> 2026-08-22, preserved verbatim so there is always an unmodified baseline to measure
> against. The living, tick-as-you-go copy is `2026-08-22-skyneet-survivors.md`.
>
> Known drift in the living copy, as of the freeze: the git-branch constraint now names
> `main`, and Task 9's steps are ticked with implementation notes. Nothing else differs.
