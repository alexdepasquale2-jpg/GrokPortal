...
The s&box project lives in [`skyneet-survivors/`](skyneet-survivors/) (scaffold after spec sign-off). Open **that** folder in the editor.

## Branch

Design work starts on `feat/skyneet-survivors-design`.
